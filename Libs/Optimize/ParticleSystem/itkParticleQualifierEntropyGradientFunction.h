...
public:
 /** Standard class typedefs. */
  ...
  {
    typename ParticleQualifierEntropyGradientFunction<TGradientNumericType, VDimension>::Pointer copy =
      ParticleQualifierEntropyGradientFunction<TGradientNumericType, VDimension>::New();
